 ...
 *   product_variant_id bigint references product_variante(id),
 *   uom_base varchar(5) not null, -- tipo UomBase enum
 *   width_mm int,
 *   height_mm int,
 *   quantity numeric(12,3) not null,
 *   finishing varchar(120),
 *   observation text,
 *   lost_factor numeric(5,2) default 0,
 *   base_expected_consumption numeric(14,4)   -- calculado
 * );
 */
@Entity
